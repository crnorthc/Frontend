...
export const CONFIRMING_CODE = "CONFIRMING_CODE";
...
export const ADMIN_RESTRICT = "ADMIN_RESTRICT";
...
export const MYGAMES_LOADED = "MYGAMES_LOADED";
...
export const COMPARED = 'COMPARED'
