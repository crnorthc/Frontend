			...
			<div >
				<div className="relative  w-full h-screen bg-dark overflow-hidden">
					<div className="fixed w-full z-20 l-0">
						<div className="relative p-5 items-center justify-between">
							<div>
							...
							<div className="grid grid-cols-12 gap-0 w-full">
								...
								<div className="col-span-12 lg:col-span-7 flex flex-col justify-center items-center">
									...
									<div className="flex flex-col justify-center items-center pt-5 sm:pt-16">
										<Link href={props.logged_in ? '/games/mygames' : "/signup"}>
											<a className="z-10 w-60 sm:w-96 p-2 mb-4 bg-primary rounded-2xl text-light  text-center text-xl sm:text-3xl glory transition duration-100 ease-in-out transform hover:scale-105 signup-shadow">{props.logged_in ? "My Games" : 'Get Started'}</a>
										</Link>
										<Link href={props.logged_in ? '/games' : "/login"}>
											<a className="z-10 w-60 sm:w-96 p-2 bg-secondary rounded-2xl text-light text-center text-xl sm:text-3xl  glory transition duration-100 ease-in-out transform hover:scale-105 login-shadow">{props.logged_in ? "Find a Game" : "I Already Have an Account"}</a>
										</Link>
									</div>
								</div>
							</div>
					...
					<div className="absolute w-full h-screen bottom-0 left-0 flex items-center justify-evenly">
					...
					<div className="moving-chart absolute w-full h-screen bottom-0 left-0 flex flex-col items-center justify-between">
